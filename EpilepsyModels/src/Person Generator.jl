...
@with_kw struct Person{T<:NamedTuple}
    ...
    measurements::AbstractVector = Vector{@NamedTuple{timepoint::AbstractFloat, measurement::AbstractFloat, state::Symbol}}() #vector of NamedTuples of the form timepoint, measurement
